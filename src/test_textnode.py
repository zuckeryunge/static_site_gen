...
class TestTextNodeSplitWithDelimiter(unittest.TestCase):
    ...
    def test_multiple_blocks(self):
        ...
        split_nodes =  [
            ...
            TextNode(" at the back. **but wait** there's more.", TextType.TEXT),
        ]
        self.assertEqual(new_nodes, split_nodes)


    def test_multiple_blocks_and_types(self):
        node = TextNode("`code is` already at the start `but also` at the back. **but wait** there's more.", TextType.TEXT)
        new_nodes = split_nodes_delimiter([node], "`", TextType.CODE)
        ...
        split_nodes =  [
            ...
            TextNode(" already at the start ", TextType.TEXT),
            TextNode("but also", TextType.CODE),
            TextNode(" at the back. ", TextType.TEXT),
            TextNode("but wait", TextType.BOLD),
            TextNode(" there's more.", TextType.TEXT),
        ]
        self.assertEqual(newer_nodes, split_nodes)
